...
/**
  ----------------------------------------------------------
    DynamicForm v1.48
  ----------------------------------------------------------
    Built Thursday, June 30th, 2022, 9:45:15 AM PDT
  ----------------------------------------------------------
**/


if (jQuery) {
    var jQueryVersion = jQuery.fn.jquery.split('.'); // E.g. ["1", "10", "2"]
    var jqueryMinorVersion = parseInt(jQueryVersion[1]);

    if (jQueryVersion[0] === "1" && (jqueryMinorVersion >= 7 && jqueryMinorVersion <= 12)) {
        var jQuery_dyfo = jQuery;
    }
    else {
        throw new Error("This jQuery version (" + jQuery.fn.jquery + ") is not compatible with DyFo V1. Use jQuery v1.7.x - v1.12.x");
    }
}
...
if (jQuery_dyfo) {
    (function (window, document, $, undefined) {
        ...
        var JA_DIVISION_SHOW_HIDE = function () {
            if ($("#C_Country").val() === 'Japan' && $("#C_Company").val() !== "") {
              $("#C_Division-form-group").show().removeAttr('style').find('input').addClass('required');
            } else {
              $("#C_Division-form-group").hide().find('input').removeClass('required').val('');
            }
          };
        ...
        dynamicForm.Util = {
            ...
            GetLanguageCode: function (shouldConvert) {
                ...
                // ITMKTGDYFO-984 - kr and pt need to change to ko and pt-br for 
                // pathing to the preference center. passing true to GetLanguageCode
        ...
        dynamicForm.BuildOptions = function (opts) {
            ...
            var _sandbox = {
                QA_Version: "1.48 SANDBOX + jQuery " + $.fn.jquery,
                elqSiteId: "711611696"
            };
            var _production = {
                QA_Version: "1.48 + jQuery " + $.fn.jquery,
            ...
            $.when(deferred).then(function () {
                ...
                dynamicForm.options.form.fields["division"] = {
                    standard: true,
                    type: "text",
                    cls: "form-control",
                    display: true,
                ...
                dynamicForm.options.form.fields["department"] = {
                    ...
                    id: "C_Department1",
                    name: "C_Department1",
                    options: [dynamicForm.options.DefaultValue, "IT - Applications/Development", "IT - Business Intelligence", "IT - Database", "IT - Desktop/Help Desk", "IT - Network", "IT - Operations", "IT - Project Management", "IT - Quality/Testing", "IT - Risk/Compliance/Security", "IT - Server/Storage", "IT - Telecom", "IT - Web", "Customer Service/Call Center", "Executive Office", "Finance", "Human Resources", "Legal", "Marketing Communications", "Research & Development", "Sales"]
                };
        ...
        dynamicForm.Lookup = {
            ...
            Config: function () {
                ...
                var configId = parseInt(
                    $.url(this.href).param("config") ||

                    $('#' + dynamicForm.options.elqFormContainerId).attr('data-config-id')
                );
        ...
        dynamicForm.form = {
            ...
            Long: function (opts) {
                ...
                $.when(dynamicForm.Lookup.Contact()).then(function () {
                    ...
                    $.when(dynamicForm.Translate(document.getElementById(dynamicForm.options.elqFormContainerId))).then(function () {
                        ...
                        // Run Japan Company Division show/hide on initial value
                        JA_DIVISION_SHOW_HIDE();

                        // Run email opt-in show/hide whenever country is changed
                        $("#C_Country").on("change", US_STATES_SHOW_HIDE);

                         // Run Japan Company Division show/hide whenever country or company is changed
                        $("#C_Country").on("change", JA_DIVISION_SHOW_HIDE);
                        $("#C_Company").on("change", JA_DIVISION_SHOW_HIDE);
            ...
            DoSubmit: function () {
                ...
                function injectDivisionIfPresent(dataObj) {
                    if (!dataObj['C_Division']) return dataObj;

                    var divisionUdfKey = 42;
                    dataObj['UDF_' + divisionUdfKey + '_Question'] = 'Division';
                    dataObj['UDF_' + divisionUdfKey + '_Answer'] = dataObj['C_Division'];
                    delete dataObj['C_Division'];
                ...
                */
                ...
                injectDivisionIfPresent(dataAsJson);
            ...
            UpdateJobRoleList: function () {
                ...
                switch (selected_dept) {
                    case "IT - Applications/Development":
                        options = ["Account Executive", "Accounting", "Analyst", "Architect", "Assistant", "Automation Architect", "CDO", "CEO", "CFO", "Chairman", "Chief Architect", "Chief Scientist", "CIO", "CISO", "CMO", "Compliance Officer", "Consultant", "COO", "CTO", "Data Scientist", "Database Administrator", "Developer", "Director", "Engineer", "Executive", "Finance", "General Counsel", "Industry Analyst", "IT Auditor", "Lawyer", "Legal Services", "Manager", "Media", "Network Administrator", "Owner", "Partner", "President", "Press", "Procurement", "Product Manager", "Programmer", "Purchasing", "Solicitor", "Student", "System Administrator", "Vice President", "Webmaster"];
                        break;
